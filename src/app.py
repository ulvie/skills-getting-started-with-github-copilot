...
activities = {
    ...
    "Swim Club": {
        "description": "Practice swimming techniques and build endurance",
    ...
    "Drama Club": {
        "description": "Rehearse and perform school theater productions",
    ...
    "Debate Team": {
        "description": "Develop research and public speaking skills",
